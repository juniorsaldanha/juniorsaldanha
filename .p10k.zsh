# Generated by Powerlevel10k configuration wizard on 2021-08-14 at 04:40 -03.
...
# 12h time, 2 lines, disconnected, sparse, concise, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION="$EMOJI >"
